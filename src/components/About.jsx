import aboutImg from '../assets/Imagem_CV.jpg';
  ...
  return (
    <div className="border-b border-neutral-900 pb-4">
        ...
        <div className="flex flex-wrap">
            ...
            <motion.div whileInView={{opacity: 1, x: 0 }} initial={{opacity: 0, x: 100 }} transation={{ duration: 0.5 }} className='w-full lg:w-1/2'>
