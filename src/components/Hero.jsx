        ...
        <div className="flex flex-wrap  ">
            <div className="w-full lg:w-1/2"> 
                <div className="flex flex-col items-center lg:items-start"> 
                    <motion.h1 initial={{x: -100, opacity: 0}} animate={{x: 0, opacity: 1}} transition={{ duration:0.5, delay: 5 }} className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text8xl">Kevin Rush</motion.h1>
