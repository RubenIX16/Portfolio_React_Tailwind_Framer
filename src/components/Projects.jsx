        ...
        <div className="flex flex-wrap justify-center align-middle">
            {PROJECTS.map((project, index) => (
                <div key="index" className="mb-8 flex flex-wrap lg:justify-center">
                    <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0 , x: -100 }} transition={{ duration: 1 }} className="w-full lg:w-96 flex justify-center lg:justify-start">
                        <img src={project.image} alt={project.title}  className=" w-96 object-fill object-center mb-6 rounded align-center justify-center lg:mr-0" />
                    </motion.div>
